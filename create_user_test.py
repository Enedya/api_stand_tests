...
def test_create_user_2_letter_in_first_name_get_success_response():
    ...
    def test_create_user_2_letter_in_first_name_get_success_response():
        # La versión actualizada del cuerpo de solicitud que contiene el
        # nombre "Aa" se guarda en la variable "user_body"
        user_body = get_user_body("Aa")
        # El resultado de la solicitud relevante se guarda en la variable "user_response"
        user_response = sender_stand_request.post_new_user(user_body)
        ...
        # El resultado de la solicitud de recepción de datos de la tabla
        # "user_model" se guarda en la variable "users_table_response"
        ...
        def positive_assert(first_name):
            ...
            # El resultado de la solicitud de recepción de datos de la
            # tabla "user_model" se guarda en la variable "users_table_response"
            users_table_response = sender_stand_request.get_users_table()
